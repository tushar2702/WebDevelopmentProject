    ...
    public static class HTML_Tools
    {
            ...
            (StringBuilder builder, string data)
        {
            ...
            else
            {
                ...
                builder.Append(TextToHTML(data));
            }
...
+ shut_css_inline;
        ...
        /*
         * Functions to convert text to HTML encoded text.
         */


        /// <summary>
        /// HTML encodes the given source so that it may placed
        /// on a web page and viewed properly.
        /// 
        ...
        /// 
        /// Tabs will be replaced by spaces.  Assumes tabsize = 4.
        /// 
        ...
        /// 
        /// In August 2009, the original code was replaced by
        /// a call to the more general method:
        /// 
        ///   SearchTools.HighlightMarkup
        /// 
        /// At this time, the HTML encoding was strengthened to
        /// include all Latin-0 punctuation marks.
        /// </summary>
        /// <param name="source">The source string</param>
        /// <returns>The source with HTML encoding</returns>
        public static string TextToHTML(string source)
        {
            return TextToHTML(source, 4, false);
        }
        ...
        /// <returns>The source with HTML encoding</returns>
        public static string TextToHTML(string source, int tabsize)
        {
            return TextToHTML(source, tabsize, false);
        }
        ...
        /// <returns>The source with HTML encoding and perhaps line numbers</returns>
        public static string TextToHTML
            (string source, int tabsize, bool showLineNumbers)
        {
            return SearchTools.HighlightMarkup
                (source, null, tabsize, showLineNumbers, true);
        }
