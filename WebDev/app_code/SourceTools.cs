...
does not represent a tilde path that may be served.
            ...
            DateTime? modifiedLast)
        {
            ...
            a = createdFirst.Value.ToShortDateString();
            b = createdFirst.Value.ToLongTimeString();

            HTML_Tools.AppendTableRow(builder, "Created First", a, b);

            a = createdLast.Value.ToShortDateString();
            b = createdLast.Value.ToLongTimeString();

            HTML_Tools.AppendTableRow(builder, "Created Last", a, b);

            a = modifiedFirst.Value.ToShortDateString();
            b = modifiedFirst.Value.ToLongTimeString();

            HTML_Tools.AppendTableRow(builder, "Modified First", a, b);

            a = modifiedLast.Value.ToShortDateString();
            b = modifiedLast.Value.ToLongTimeString();
